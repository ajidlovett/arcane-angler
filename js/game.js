...
// ========================================
// EXTRACTED COMPONENTS (moved outside FishingGame to prevent re-creation and infinite loops)
// ========================================
...
// ========================================
// PAGE COMPONENTS (extracted outside FishingGame to prevent re-mounting)
// ========================================

const OptionsPage = ({ theme, currentTheme, setCurrentTheme, buttonColors, castButtonColor, setCastButtonColor }) => (
  <div className="max-w-4xl mx-auto">
...
const Sidebar = ({ player, theme, currentPage, setCurrentPage, sidebarOpen, setSidebarOpen, handleSaveAndLogout, setPlayer }) => {
  const menuItems = [
...
// Boosters Page Component
const BoostersPage = ({ player, setPlayer, theme, showConfirm, showAlert }) => {
  const [activeBoosters, setActiveBoosters] = React.useState([]);
  const [loading, setLoading] = React.useState(true);
