      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8">
        ...
        <div className="mt-6 text-center">
          ...
          <button
            ...
            className="mt-4 w-full bg-gray-600 text-white py-3 px-4 rounded-lg font-bold hover:bg-gray-700 transition-all"
          >
            Play Offline (Local Save Only)
          </button>
          <p className="text-xs text-gray-500 mt-2">
            Offline mode uses browser storage. No leaderboards or cross-device sync.
          </p>
        </div>
      </div>
    </div>
