...
CREATE TABLE IF NOT EXISTS users (
    ...
    nationality VARCHAR(10) DEFAULT NULL COMMENT 'ISO 3166-1 alpha-2 country code',
    profile_name_changes INT DEFAULT 0,
    achievement_showcase_limit INT DEFAULT 6,
    favorite_fish_limit INT DEFAULT 3,
    profile_privacy ENUM('public', 'friends', 'private') DEFAULT 'public',
    allow_comments BOOLEAN DEFAULT TRUE,
    profile_views INT DEFAULT 0,
    badges JSON DEFAULT NULL,
    owned_avatars JSON DEFAULT NULL COMMENT 'Array of owned avatar IDs',
    profile_avatar VARCHAR(50) DEFAULT 'avatar_001' COMMENT 'Currently selected avatar ID',
    fish_showcase JSON DEFAULT NULL COMMENT 'Array of showcased fish objects',
    achievement_showcase JSON DEFAULT NULL COMMENT 'Array of showcased achievement IDs',
